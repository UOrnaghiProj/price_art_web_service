...
{
	/*
	 * URL Swagger: http://localhost:5071/swagger-ui.html
	...
	private ApiInfo apiInfo() 
	{
		return new ApiInfoBuilder()
				.title("PRICEART WEB SERVICE API")
                .description("Spring Boot REST API per la gestione dei listini e prezzi Shop")
                .version("1.0.0")
